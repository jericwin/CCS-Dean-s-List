...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2025 at 03:17 PM
...
CREATE TABLE `announcements` (
  ...
  `body` text NOT NULL,
  `image_path` varchar(255) DEFAULT NULL,c:\xampp\mysql\bin\student_portal.sql
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5, 'Jeric Punay', 'bsit_1a', 'flowchart.jpg', 'flowchart.jpg', 'Pending', NULL, '2025-10-28 12:38:06', 1.50),
(7, 'Jeric Punay', 'bsit_4b', 'AI_VChapter_1.pdf', 'Blue_and_Light_Orange_Modern_Illustrative_Project_Timeline_Gantt_Chart_2.png', 'Approved', 'None', '2025-10-28 13:03:04', 1.75);
